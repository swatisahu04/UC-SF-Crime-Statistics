...
def run_spark_job(spark):
    ...
    distinct_table = service_table.select( \
                    psf.col("original_crime_type_name"), psf.col("disposition"), \
    ...
    radio_code_json_filepath = "/Users/swatisahu/Desktop/Kafka/Udacity_Kafka/sf-crime-data-project-files/radio_code.json"
    ...
    join_query_o = join_query\
                    .writeStream\
                    .queryName("join_query_output")\
                    .outputMode("append")\
                    .format("console")\
                    .start()


    join_query_o.awaitTermination()
